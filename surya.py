...
def siapa():
	os.system('clear')
	nama = raw_input("\033[1;97mSaha Ngaran Maneh ? \033[1;91m: \033[1;92m")
	if nama =="":
		print"\033[1;96m[!] \033[1;91mIsi Cing Bener"
		time.sleep(1)
		siapa()
	else:
		os.system('clear')
	...
	try:
		...
		if 'save-device' in url:
			try:
				...
				os.system('xdg-open https://www.youtube.com/channel/UCj5DR1drGlRXRDqP3sRcLqA')
				menu()
